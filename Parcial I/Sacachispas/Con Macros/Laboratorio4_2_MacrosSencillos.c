...
#define PRECIOSENCILLA 60
#define PRECIODOBLE 80
#define PRECIOTRIPLE 100
...
int main() {
	...
	for (cont_clientes = 1; cont_clientes <= clientes; cont_clientes++)
	{
		...
		case 's':
			...
			total_pagar += numero_hamburguesas * PRECIOSENCILLA;
		...
		case 'd':
			...
			total_pagar += numero_hamburguesas * PRECIODOBLE;
		...
		case 't':
			...
			total_pagar += numero_hamburguesas * PRECIOTRIPLE;
...
-Los macro funcionan correctamente al almacenar el precio y operar.
*/
