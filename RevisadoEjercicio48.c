...
/*El programa funciona correctamente pero el ciclo debe ser para 500 alumnos. 
No se especifíca cuando se quieren insertar votos nulos
Recomendación: Separar un poco el código para que sea más fácil de entenderlo. En la línea 29, no era necesaria la condición con el if 
