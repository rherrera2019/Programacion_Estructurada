...
//Funciona bien
/*Observaciones
Para salir del programa dice que debes poner (S) 
pero si pones S mayúsucula, el programa continua
estaría bien que al igual que al poner la enfermedad, especificar que debe ser s minúscula

Al salir del programa, no aparece ningún mensaje de que se haya salido correctamente del programa
solamente se queda en negro la consola*/

//Revisado por Abigael Arjona. Programación estructurada.
